...
util.add_prerequisite("advanced-circuit", "silver-processing")
...
util.add_prerequisite("processing-unit", "gold-processing")
util.remove_prerequisite("processing-unit", "chemical-science-pack")
util.add_prerequisite("processing-unit", "temperature-regulation")
util.add_prerequisite("processing-unit", "advanced-capacitors")
